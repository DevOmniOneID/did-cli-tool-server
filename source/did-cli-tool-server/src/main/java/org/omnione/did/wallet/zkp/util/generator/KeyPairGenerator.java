...
public class KeyPairGenerator {
    ...
    public static CredentialPrimaryKeyPair generatePublicKey(BigInteger p, BigInteger q, List<String> attrNames, String masterSecret) throws ZkpException {
        ...
        try {
            ...
            try {
                ...
                n = p.shiftLeft(1).multiply(q.shiftLeft(1));
                // 네이밍 = (Q_safe), Random R
    ...
    public static CredentialPrimaryPrivateKey generatePrivateKey(String masterSecret) throws ZkpException {
