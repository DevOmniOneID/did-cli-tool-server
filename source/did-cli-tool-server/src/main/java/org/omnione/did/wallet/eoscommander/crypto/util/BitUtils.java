...
public class BitUtils {
	...
	public static long uint32ToLong(byte[] buf, int offset) {
		return ((buf[offset++] & 0xFFL)) | ((buf[offset++] & 0xFFL) << 8)
				| ((buf[offset++] & 0xFFL) << 16) | ((buf[offset] & 0xFFL) << 24);
	}

	public static long uint64ToLong(byte[] buf, int offset) {
		return ((buf[offset++] & 0xFFL)) | ((buf[offset++] & 0xFFL) << 8)
				| ((buf[offset++] & 0xFFL) << 16) | ((buf[offset++] & 0xFFL) << 24)
				| ((buf[offset++] & 0xFFL) << 32) | ((buf[offset++] & 0xFFL) << 40)
	...
	public static long uint64FromStream(DataInputStream stream) throws IOException {
		return ((stream.read() & 0xFFL)) | ((stream.read() & 0xFFL) << 8)
				| ((stream.read() & 0xFFL) << 16) | ((stream.read() & 0xFFL) << 24)
				| ((stream.read() & 0xFFL) << 32) | ((stream.read() & 0xFFL) << 40)
				| ((stream.read() & 0xFFL) << 48) | ((stream.read() & 0xFFL) << 56);
	}

	public static void uint32ToStream(long value, OutputStream stream)
			throws IOException {
	...
	public static void uint64ToStream(long value, OutputStream stream)
			throws IOException {
		stream.write((byte) (0xFFL & (value)));
		stream.write((byte) (0xFFL & (value >> 8)));
		stream.write((byte) (0xFFL & (value >> 16)));
