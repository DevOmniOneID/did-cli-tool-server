...
public class TransactionReceiptHeader {
	...
	// hard_fail = 2, ///< objectively failed and error handler objectively failed thus no
	// state change
	...
	@Expose
	public long net_usage_words;/// < total billed NET usage, so we can reconstruct
								/// resource state when skipping context free data... hard
								/// failures...
